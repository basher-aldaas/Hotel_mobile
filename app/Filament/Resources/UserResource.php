        ...
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('password')
                    ->password()
                    ->maxLength(255)
                    ->required(fn ($livewire) => $livewire instanceof \Filament\Resources\Pages\CreateRecord) // مطلوب عند الإنشاء فقط
                    ->dehydrated(fn ($state) => filled($state)) // لا تحفظ إذا فارغ (عند التعديل)
                    ->label('Password'),
            ]);
    }
